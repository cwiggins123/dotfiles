...
(use-package counsel
  ...
  :custom
  (consel-linux-app-format-function #'counsel-linux-app-format-function-name-only)
  :config
  (counsel-mode 1))
...
(use-package projectile
  ...
  (when (file-directory-p "~/Projects/Code")
    (setq projectule-project-search-path '("~/Projects/Code")))
...
(defun efs/configure-eshell ()
  ...
  (evil-define-key '(normal insert visual) eshell-mode-map (kbs "C-r") 'counsel-esh-history)
...
(custom-set-variables
 ...
 '(package-selected-packages
   '(auto-package-update srcery-theme evil-collection evil general rainbow-delimiters ivy command-log-mode use-package)))
(custom-set-faces
